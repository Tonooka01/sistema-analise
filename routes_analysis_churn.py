...
>>>>>>> 31460d2af41317c21a3248300750f4b8c462c4cd
    FinancialStats AS (
        SELECT
...
def api_real_permanence():
    ...
    try:
        ...
        chart_paga_query = f"""
            ...
            SELECT 
                CASE 
                    ...
                    WHEN Permanencia_Paga BETWEEN 19 AND 24 THEN '19-24'
                    WHEN Permanencia_Paga BETWEEN 25 AND 36 THEN '25-36'
                    ELSE '37+'
                END as Faixa,
                COUNT(*) as Count
        ...
        chart_real_query = f"""
            ...
            SELECT 
                CASE 
                    ...
                    WHEN Permanencia_Real_Calendario BETWEEN 19 AND 24 THEN '19-24'
                    WHEN Permanencia_Real_Calendario BETWEEN 25 AND 36 THEN '25-36'
                    ELSE '37+'
                END as Faixa,
                COUNT(*) as Count
            FROM JoinedData AS JD {where_sql_charts}
        ...
        # Query Por Cidade (Com tratamento correto de WHERE e alias JD)
        ...
        # IMPORTANTE: A ordem dos parâmetros deve ser CTE + OUTER QUERY
        ...
        # --- DADOS DA TABELA ---
        # Parâmetros para tabela: CTE + Filtros Finais (Relevância)
